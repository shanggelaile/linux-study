...
#define DEVICE_NAME			"mynotifier1"	/* 名字 */

#define CLOSE_CMD 		(_IO(0XEF, 0x1))	/* 关闭 */
#define OPEN_CMD		(_IO(0XEF, 0x2))	/* 打开 */


extern struct blocking_notifier_head my_notifier_list;
...
static int __init chrdevbase_init(void)
{
	...
	/* call notifier */
	printk(KERN_ALERT "test notifier client!\n");
	blocking_notifier_call_chain(&my_notifier_list, 1, NULL);
	return 0;
