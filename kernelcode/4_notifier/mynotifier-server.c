...
#define DEVICE_NAME			"mynotifier2"	/* 名字 */
...
EXPORT_SYMBOL(my_notifier_list);
...
/*
 * @description		: notifier callback function
 * @param - nb 	: tarnsmission data
 */
		...
		unsigned long action, void *data)
{
	switch (action) {
		case 0:
			printk(KERN_ALERT "notifier 0.\r\n");
			break;
		case 1:
			printk(KERN_ALERT "notifier 1.\r\n");
			break;
		default:
			printk(KERN_ALERT "notifier error.\r\n");
			break;
	}
	return 0;
}

static struct notifier_block my_notifier_nb = {
...
static int __init chrdevbase_init(void)
{
	...
	/* init notifier */
	printk(KERN_ALERT "notifier server!\n");
	blocking_notifier_chain_register(&my_notifier_list, &my_notifier_nb);
	return 0;
